...
function addMarker(location) {
    ...
    marker = new google.maps.Marker({
        ...
        icon: 'icons/' + location.category + '.png',
        map: gMap
    });

    var content = "<a style='font-size:22px; font-family: BRITANNIC BOLD' href='http://www.weworkinphilly.com/companies/" + location.user_id + "'>" + location.name + "</a>" + "<div>" + location.location + "<br /> <a href=" + location.website + " target='_blank'>" + location.website + "</a> </div><div> " + location.category + "</div>";
